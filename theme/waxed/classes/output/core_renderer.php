...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function full_header() {
        ...
        $html .= html_writer::start_div('rocket');
        $html .= html_writer::tag('img','',array('src'=>'https://cdn.discordapp.com/attachments/295938845692919809/469493548295913473/rocket.gif'));

        $html .= html_writer::end_div(); // End rocket.
